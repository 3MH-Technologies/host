...
export const TRANSITIONS: Record<AppStatus, AppStatus[]> = {
  [APP_STATUS.CREATED]: [APP_STATUS.PREPARING, APP_STATUS.INSTALLING, APP_STATUS.STARTING, APP_STATUS.DELETING],
  [APP_STATUS.PREPARING]: [APP_STATUS.INSTALLING, APP_STATUS.STARTING, APP_STATUS.STOPPED, APP_STATUS.FAILED, APP_STATUS.DELETING],
  ...
  [APP_STATUS.FAILED]: [APP_STATUS.STARTING, APP_STATUS.REBUILDING, APP_STATUS.DELETING],
  [APP_STATUS.REBUILDING]: [APP_STATUS.INSTALLING, APP_STATUS.STARTING, APP_STATUS.STOPPED, APP_STATUS.FAILED, APP_STATUS.DELETING],
